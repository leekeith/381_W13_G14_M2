...
/*
 * Writes a char array of known length to specified file.
 */
void sdcard_writefile_sz(char write_data[], short int file_handle, int byteCount)
{
	int i;
	for(i=0;i<byteCount;i++)
		alt_up_sd_card_write(file_handle, write_data[i]);
